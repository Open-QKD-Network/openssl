...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_START
    ...
    {OQS_KEM_CURVEID(NID_newhope512cca), "newhope512cca"},
    {OQS_KEM_CURVEID(NID_newhope1024cca), "newhope1024cca"},
    ...
    {OQS_KEM_CURVEID(NID_babybear), "babybear"},
    {OQS_KEM_CURVEID(NID_mamabear), "mamabear"},
    {OQS_KEM_CURVEID(NID_papabear), "papabear"},
    ...
    {OQS_KEM_CURVEID(NID_oqkd_frodo976aes), "oqkd_frodo976aes"},
    {OQS_KEM_CURVEID(NID_oqkd_frodo976shake), "oqkd_frodo976shake"},
    {OQS_KEM_CURVEID(NID_oqkd_frodo1344aes), "oqkd_frodo1344aes"},
    {OQS_KEM_CURVEID(NID_oqkd_frodo1344shake), "oqkd_frodo1344shake"},
    {OQS_KEM_CURVEID(NID_oqkd_kyber512), "oqkd_kyber512"},
    {OQS_KEM_CURVEID(NID_oqkd_kyber768), "oqkd_kyber768"},
    {OQS_KEM_CURVEID(NID_oqkd_kyber1024), "oqkd_kyber1024"},
    {OQS_KEM_CURVEID(NID_oqkd_kyber90s512), "oqkd_kyber90s512"},
    {OQS_KEM_CURVEID(NID_oqkd_kyber90s768), "oqkd_kyber90s768"},
    {OQS_KEM_CURVEID(NID_oqkd_kyber90s1024), "oqkd_kyber90s1024"},
    {OQS_KEM_CURVEID(NID_oqkd_ntru_hps2048509), "oqkd_ntru_hps2048509"},
    {OQS_KEM_CURVEID(NID_oqkd_ntru_hps2048677), "oqkd_ntru_hps2048677"},
    {OQS_KEM_CURVEID(NID_oqkd_ntru_hps4096821), "oqkd_ntru_hps4096821"},
    {OQS_KEM_CURVEID(NID_oqkd_ntru_hrss701), "oqkd_ntru_hrss701"},
    {OQS_KEM_CURVEID(NID_oqkd_lightsaber), "oqkd_lightsaber"},
    {OQS_KEM_CURVEID(NID_oqkd_saber), "oqkd_saber"},
    {OQS_KEM_CURVEID(NID_oqkd_firesaber), "oqkd_firesaber"},
...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_HYBRID_START
    ...
    {OQS_KEM_CURVEID(NID_p256_newhope512cca), "p256 - newhope512cca hybrid"},
    {OQS_KEM_CURVEID(NID_p521_newhope1024cca), "p521 - newhope1024cca hybrid"},
    ...
    {OQS_KEM_CURVEID(NID_p256_babybear), "p256 - babybear hybrid"},
    {OQS_KEM_CURVEID(NID_p384_mamabear), "p384 - mamabear hybrid"},
    {OQS_KEM_CURVEID(NID_p521_papabear), "p521 - papabear hybrid"},
    ...
    {OQS_KEM_CURVEID(NID_p384_oqkd_frodo976aes), "p384 - oqkd_frodo976aes hybrid"},
    {OQS_KEM_CURVEID(NID_p384_oqkd_frodo976shake), "p384 - oqkd_frodo976shake hybrid"},
    {OQS_KEM_CURVEID(NID_p521_oqkd_frodo1344aes), "p521 - oqkd_frodo1344aes hybrid"},
    {OQS_KEM_CURVEID(NID_p521_oqkd_frodo1344shake), "p521 - oqkd_frodo1344shake hybrid"},
    {OQS_KEM_CURVEID(NID_p256_oqkd_kyber512), "p256 - oqkd_kyber512 hybrid"},
    {OQS_KEM_CURVEID(NID_p384_oqkd_kyber768), "p384 - oqkd_kyber768 hybrid"},
    {OQS_KEM_CURVEID(NID_p521_oqkd_kyber1024), "p521 - oqkd_kyber1024 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_oqkd_kyber90s512), "p256 - oqkd_kyber90s512 hybrid"},
    {OQS_KEM_CURVEID(NID_p384_oqkd_kyber90s768), "p384 - oqkd_kyber90s768 hybrid"},
    {OQS_KEM_CURVEID(NID_p521_oqkd_kyber90s1024), "p521 - oqkd_kyber90s1024 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_oqkd_ntru_hps2048509), "p256 - oqkd_ntru_hps2048509 hybrid"},
    {OQS_KEM_CURVEID(NID_p384_oqkd_ntru_hps2048677), "p384 - oqkd_ntru_hps2048677 hybrid"},
    {OQS_KEM_CURVEID(NID_p521_oqkd_ntru_hps4096821), "p521 - oqkd_ntru_hps4096821 hybrid"},
    {OQS_KEM_CURVEID(NID_p384_oqkd_ntru_hrss701), "p384 - oqkd_ntru_hrss701 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_oqkd_lightsaber), "p256 - oqkd_lightsaber hybrid"},
    {OQS_KEM_CURVEID(NID_p384_oqkd_saber), "p384 - oqkd_saber hybrid"},
    {OQS_KEM_CURVEID(NID_p521_oqkd_firesaber), "p521 - oqkd_firesaber hybrid"},
...
///// OQS_TEMPLATE_FRAGMENT_POPULATE_SIGALG_TBL_START
    ...
    {TLSEXT_SIGALG_mqdss3148, "mqdss3148"},
    {TLSEXT_SIGALG_p256_mqdss3148, "p256_mqdss3148"},
    {TLSEXT_SIGALG_rsa3072_mqdss3148, "rsa3072_mqdss3148"},
