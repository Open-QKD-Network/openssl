...
/* MQDSS-31-48 auth */
#define SSL_aMQDSS3148 0x01000000U
...
/* qTesla-I-p auth */
#define SSL_aQTESLAPI 0x200000000U
/* ECDSA p256 - qTesla-I-p auth */
#define SSL_aP256_QTESLAPI 0x400000000U
/* RSA3072 - qTesla-I-p auth */
#define SSL_aRSA3072_QTESLAPI 0x800000000U
/* qTESLA-p-III auth */
#define SSL_aQTESLAPIII 0x1000000000U
/* ECDSA p384 - qTESLA-p-III auth */
#define SSL_aP384_QTESLAPIII 0x2000000000U
/* Rainbow-Ia-Classic auth */
#define SSL_aRAINBOWIACLASSIC 0x4000000000U
/* ECDSA p256 - Rainbow-Ia-Classic auth */
#define SSL_aP256_RAINBOWIACLASSIC 0x8000000000U
/* RSA3072 - Rainbow-Ia-Classic auth */
#define SSL_aRSA3072_RAINBOWIACLASSIC 0x10000000000U
/* Rainbow-Vc-Classic auth */
#define SSL_aRAINBOWVCCLASSIC 0x20000000000U
/* ECDSA p521 - Rainbow-Vc-Classic auth */
#define SSL_aP521_RAINBOWVCCLASSIC 0x40000000000U
/* SPHINCS+-Haraka-128f-robust auth */
#define SSL_aSPHINCSHARAKA128FROBUST 0x80000000000U
/* ECDSA p256 - SPHINCS+-Haraka-128f-robust auth */
#define SSL_aP256_SPHINCSHARAKA128FROBUST 0x100000000000U
/* RSA3072 - SPHINCS+-Haraka-128f-robust auth */
#define SSL_aRSA3072_SPHINCSHARAKA128FROBUST 0x200000000000U
...
#define SSL_PKEY_RAINBOWVCCLASSIC 42
#define SSL_PKEY_P521_RAINBOWVCCLASSIC 43
#define SSL_PKEY_SPHINCSHARAKA128FROBUST 44
#define SSL_PKEY_P256_SPHINCSHARAKA128FROBUST 45
#define SSL_PKEY_RSA3072_SPHINCSHARAKA128FROBUST 46

#define SSL_PKEY_NUM 47
...
#define OQS_KEM_CURVEID(nid) \
  ...
  (nid == NID_babybear ? 0x022C : \
  (nid == NID_mamabear ? 0x022D : \
  (nid == NID_papabear ? 0x022E : \
  ...
  (nid == NID_oqkd_ntru_hps2048509 ? 0x0276 : \
  (nid == NID_oqkd_ntru_hps2048677 ? 0x0277 : \
  (nid == NID_oqkd_ntru_hps4096821 ? 0x0278 : \
  (nid == NID_oqkd_ntru_hrss701 ? 0x0279 : \
  (nid == NID_oqkd_lightsaber ? 0x027a : \
  (nid == NID_oqkd_saber ? 0x027b : \
  (nid == NID_oqkd_firesaber ? 0x027c : \
  0 \
  )))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
...
#define OQS_KEM_HYBRID_CURVEID(nid) \
  (nid == NID_p256_oqs_kem_default      ? 0x2FFF : \
    ...
    (nid == NID_p256_oqkd_ntru_hps2048509 ? 0x2F76 : \
    (nid == NID_p384_oqkd_ntru_hps2048677 ? 0x2F77 : \
    (nid == NID_p521_oqkd_ntru_hps4096821 ? 0x2F78 : \
    (nid == NID_p384_oqkd_ntru_hrss701 ? 0x2F79 : \
    (nid == NID_p256_oqkd_lightsaber ? 0x2F7a : \
    (nid == NID_p384_oqkd_saber ? 0x2F7b : \
    (nid == NID_p521_oqkd_firesaber ? 0x2F7c : \
  0 \
  )))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
...
#define OQS_KEM_NID(curveID) \
  ...
  (curveID == 0x0212 || curveID == 0x2F12 ? NID_newhope512cca : \
  (curveID == 0x0213 || curveID == 0x2F13 ? NID_newhope1024cca : \
  ...
  (curveID == 0x022C || curveID == 0x2F2C ? NID_babybear : \
  (curveID == 0x022D || curveID == 0x2F2D ? NID_mamabear : \
  (curveID == 0x022E || curveID == 0x2F2E ? NID_papabear : \
  ...
  (curveID == 0x0276 || curveID == 0x2F76 ? NID_oqkd_ntru_hps2048509 : \
  (curveID == 0x0277 || curveID == 0x2F77 ? NID_oqkd_ntru_hps2048677 : \
  (curveID == 0x0278 || curveID == 0x2F78 ? NID_oqkd_ntru_hps4096821 : \
  (curveID == 0x0279 || curveID == 0x2F79 ? NID_oqkd_ntru_hrss701 : \
  (curveID == 0x027a || curveID == 0x2F7a ? NID_oqkd_lightsaber : \
  (curveID == 0x027b || curveID == 0x2F7b ? NID_oqkd_saber : \
  (curveID == 0x027c || curveID == 0x2F7c ? NID_oqkd_firesaber : \
  0 \
  )))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
...
#define OQS_HYBRID_KEM_NID(curveID) \
  (curveID == 0x2FFF ? NID_p256_oqs_kem_default : \
    ...
    (curveID == 0x2F76 ? NID_p256_oqkd_ntru_hps2048509 : \
    (curveID == 0x2F77 ? NID_p384_oqkd_ntru_hps2048677 : \
    (curveID == 0x2F78 ? NID_p521_oqkd_ntru_hps4096821 : \
    (curveID == 0x2F79 ? NID_p384_oqkd_ntru_hrss701 : \
    (curveID == 0x2F7a ? NID_p256_oqkd_lightsaber : \
    (curveID == 0x2F7b ? NID_p384_oqkd_saber : \
    (curveID == 0x2F7c ? NID_p521_oqkd_firesaber : \
  0 \
  )))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
...
#define OQS_ALG_NAME(nid) \
  ...
  (nid == NID_babybear ? OQS_KEM_alg_threebears_babybear : \
  (nid == NID_mamabear ? OQS_KEM_alg_threebears_mamabear : \
  (nid == NID_papabear ? OQS_KEM_alg_threebears_papabear : \
  ...
  (nid == NID_oqkd_ntru_hps2048509 ? OQS_KEM_alg_ntru_hps2048509 : \
  (nid == NID_oqkd_ntru_hps2048677 ? OQS_KEM_alg_ntru_hps2048677 : \
  (nid == NID_oqkd_ntru_hps4096821 ? OQS_KEM_alg_ntru_hps4096821 : \
  (nid == NID_oqkd_ntru_hrss701 ? OQS_KEM_alg_ntru_hrss701 : \
  (nid == NID_oqkd_lightsaber ? OQS_KEM_alg_saber_lightsaber : \
  (nid == NID_oqkd_saber ? OQS_KEM_alg_saber_saber : \
  (nid == NID_oqkd_firesaber ? OQS_KEM_alg_saber_firesaber : \
  0 \
  )))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
